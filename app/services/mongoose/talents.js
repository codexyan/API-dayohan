...
const createTalents = async (req) => {
    ...
    // apabila check true
    // atau data talents sudah ada maka kita tampilkan error bad request dengan message pembicara duplikat
    if (check) throw new BadRequestError("Nama pembiacara duplikat");
...
const updateTalents = async (req) => {
    ...
    // jika id result false / null maka akan menampilkan error `Tidak ada pembicara dengan id` yang dikirim ke client
    if (!result) throw new NotFoundError(`Tidak ada pembiacara dengan id: ${id}`);
